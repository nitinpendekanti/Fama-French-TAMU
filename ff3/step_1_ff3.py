""" Fama French 3 Step 1 Replication """
...
"""Get Market Equity for HML"""
if useCache:
  bookToMarket = joblib.load("../data/bookToMarket.joblib")
else:
  ...
  joblib.dump(bookToMarket, "../data/bookToMarket.joblib")
...
if useCache:
  portfolios = joblib.load("../data/portfolios-step-1-ff3.joblib")
else:
  ...
  joblib.dump(portfolios, "../data/portfolios-step-1-ff3.joblib")
...
ff3FactorsReplicated.to_csv("factors-replicated-step-1.csv", index=False)
joblib.dump(ff3FactorsReplicated, '../data/ff3_factors_replicated_step_1.joblib')